...
//class OwnerAddService
class OwnerAddService extends Component {
  state = {
    Service: {
      service_id: "",
      service_name: "",
...
OwnerAddService.propTypes = {
  classes: PropTypes.object.isRequired,
};

//exporting OwnerAddService
export default withStyles(styles)(OwnerAddService);
