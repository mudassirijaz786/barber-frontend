...
class AddServiceRecommended extends Component {
  state = {
    Service: {
      service_id: "",
...
AddServiceRecommended.propTypes = {
  classes: PropTypes.object.isRequired,
};

export default withStyles(styles)(AddServiceRecommended);
